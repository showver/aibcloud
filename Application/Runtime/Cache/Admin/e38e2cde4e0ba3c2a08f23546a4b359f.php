...
<body style="color: black; overflow-x: hidden;">
    ...
    <div id="wrapper" style="height: 100vh;">
        <div id="header" style=" height:80px;">
            <h2 style="font-size: 25px;">技术文档</h2>
            <a href="http://aibcloud.org/" title="你可以参考这里的技术文档">你可以参考这里的技术文档</a>
        </div>
...
<!-- <div id="navbar" style=" margin:5px auto;margin-bottom:10px;background: #CCFFFF;height:50px;">
    <ul>
        ...
        <div id="main">
            <div id="content">
                <h2 style="font-size: 20px; font-weight: normal; padding:0; height: 49px;" class="file-list"><i class="icon-file-alt icon-large" style="margin:0 10px; color: black;"></i>文档列表</h2>
                ...
                <table class="file-table">
                    ...
                    <tbody>
                    <?php if(is_array($list)): foreach($list as $key=>$r): ?><tr><td><a href="<?php echo ($r["doc_link"]); ?>"><?php echo ($r["doc_title"]); ?></a></td><td align="center"><?php echo (date("Y-m-d H:i:s",$r["addtime"])); ?></td></tr><?php endforeach; endif; ?>
    				<tr><td><a href="">待定</a></td><td align="center">2017-08-11 16:54:00</td></tr>
                    </tbody>
                </table>
            ...
            <p style="margin:0;">
                AIB网络工作室云平台技术文档，集结了众多师兄姐多年来累积的精华笔记。</p>
            <p style="margin:0;">
                在这里，你能够学习到你想要的知识，获取到你未曾有过的实践经验！</p>
            <p style="margin:0;">
                平台的技术文档的是通过“看云”发布、链接而成的，更多精彩内容请多留意服务公告，感谢您的支持！</p>
