	...
	<div class="container" style="clear: both;">
			...
			<section class="row" style="margin-bottom: 10vh;">
				<article class="mess_sub">
					...
					<button type="button" onclick="send('/cloud/index.php/Admin/Stu/stuMessage/id/<?php echo ($r["id"]); ?>','fm1',1);">给他留言</button>
					</form>
				</article>
		...
		<div id="page" style="margin-top:-1500px;">
		    <div id="dialog_content" class="dialog_content" style="display:none">
		        ...
		        <div class="dialogModal_footer">
		            ...
		            <button type="button" onclick="send('./stuMessage/flag/1','fm2',1);" data-dialogModalBut="ok">留言</button>
		        </div>
		    </div>
		</div>
