...
<body>
    <div id="arrow">
        ...
        <div id="history" style="height: 90vh;">
            ...
            <div id="content">
                <ul class="list">
                    <?php if(is_array($list)): foreach($list as $key=>$r): ?><li style="margin-top:0px;">
                        <div class="liwrap">
                            <div class="lileft">
                                <div class="date">
                                    
                                    <span class="md"><?php echo (date("F d",$r["addtime"])); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="liright">
                                <div class="histt" ><a href="#" style="font-size: 1.6rem; color:rgb(107, 195, 13);"><?php echo ($r["title"]); ?></a></div>
                                <div class="hisct"><?php echo ($r["content"]); ?></div>
                            </div>
                        </div>
