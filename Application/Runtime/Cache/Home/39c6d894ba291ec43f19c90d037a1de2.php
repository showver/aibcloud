...
<body style="overflow-x: hidden;width:100vw;background-color: #ECEFF1;position: relative;">
    ...
    <ul class="list" style="position: absolute; top:50%;left:50%;transform: translate(-50%,-50%);">
      <li>
        <a class="fancybox" href="<?php echo (URL); ?>img/yum2/vSphereLogin.jpg" data-fancybox-group="gallery" title="vSphere登录"><img class="img-rounded" src="<?php echo (URL); ?>img/yum2/vSphereLogin.jpg" alt="" /></a>
      </li>
      <li>
        <a class="fancybox" href="<?php echo (URL); ?>img/yum2/vSphere.jpg" data-fancybox-group="gallery" title="vSphere"><img class="img-rounded" src="<?php echo (URL); ?>img/yum2/vSphere.jpg" alt="" /></a>
      </li>
      <li>
        <a class="fancybox" href="<?php echo (URL); ?>img/yum2/vCenten.jpg" data-fancybox-group="gallery" title="vCenten"><img class="img-rounded" src="<?php echo (URL); ?>img/yum2/vCenten.jpg" alt="" /></a>
      </li>
    </ul>
