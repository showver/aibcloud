...
// If language exists, include the language file
	if (array_key_exists($net2ftp_globals["language"], $languageArray) == true) { 
		$languageFile = glueDirectories($net2ftp_globals["application_languagesdir"], 
		$net2ftp_globals["language"]="zh.inc.php",
		$languageArray[$net2ftp_globals["language"]]["file"]);
