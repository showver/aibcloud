...
<input type="checkbox" name="zipactions[save]" value="yes" /> <!-- <?php echo __("Save the zip file on the FTP server as:"); ?> --><span>将文件压缩到目录下命名为：</span> <input type=text class="input" name="zipactions[save_filename]" value="<?php echo $zipfilename; ?>" />
</div> &nbsp; 

<div style="display:none;border-color: #000000; border-style: solid; border-width: 1px; padding: 10px; margin-<?php echo __("right"); ?>: 100px; margin-bottom: 10px;">
