...
<table style="display:none;border-color: #000000; border-style: solid; border-width: 1px; padding: 10px;">
	<tr><td>
...
<span style="display:none;"> <?php 	echo __("Unzip archive <b>%1$s</b> to:", $list["all"][$i]["dirfilename"]); ?> <br /></span>
<!-- "Unzip archive <b>%1$s</b> to:" 改了上面第一个参数-->
<?php echo "将".$list["all"][$i]["dirfilename"]."文件解压到:"; ?><br/>
