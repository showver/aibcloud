...
<?php // Do not use style="white-space: nowrap;" because then IE strips the carriage-return + linefeeds (tested on IE version 6.0) ?>
				<textarea name="text" class="edit" rows="33" style="width: 99%;display: none;" wrap="off" onkeydown="TabText()"><?php echo $text; ?></textarea>
				<script type="text/javascript">
					document.forms['EditForm'].textareaType.value='ace';
